...
ActiveRecord::Schema.define(version: 20_220_816_184_945) do
  ...
  create_table 'backtest_models', force: :cascade do |t|
    ...
    t.index %w[version sequence_number basket],
            name: 'index_backtest_models_on_version_and_sequence_number_and_basket', unique: true
  end
  ...
  create_table 'candles', force: :cascade do |t|
    ...
    t.index %w[exchange starttime pair resolution],
            name: 'index_candles_on_exchange_and_starttime_and_pair_and_resolution', unique: true
  end
  ...
  create_table 'cointegration_model_weights', force: :cascade do |t|
    ...
    t.string 'asset_name'
    t.float 'weight'
    t.index %w[uuid asset_name], name: 'index_cointegration_model_weights_on_uuid_and_asset_name', unique: true
  end
  ...
  create_table 'modeled_signals', force: :cascade do |t|
    ...
    t.index %w[model_id starttime], name: 'index_modeled_signals_on_model_id_and_starttime', unique: true
  end
  ...
  create_table 'repo_commits', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index %w[repo_id day], name: 'index_repo_commits_on_repo_id_and_day', unique: true
  ...
  create_table 'repos', force: :cascade do |t|
    ...
    t.index %w[user name token], name: 'index_repos_on_user_and_name_and_token', unique: true
  end
