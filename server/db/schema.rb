...
ActiveRecord::Schema.define(version: 20_220_811_161_226) do
  ...
  create_table 'backtest_models', force: :cascade do |t|
    ...
    t.string 'name'
    t.index %w[version sequence_number], name: 'index_backtest_models_on_version_and_sequence_number', unique: true
  end
